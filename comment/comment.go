...
// NewService - reutrnes a new comment service
...
//  GetComment - retrieves comments by their ID from the datbase
...
// UpdateComment - updates a commment by ID with new Comment info
...
// DeleteComment - deletes a comment form the database by ID
